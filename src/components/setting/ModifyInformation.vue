  ...
  <div :class="seflag==1?['text_active']:''" class="dairy_row">
      ...
      <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
        <table>
          ...
          <tr>
            ...
            <td><input v-model="autograph" class="form-control qz_text qz_text2" maxlength="16" placeholder="个性签名"></td>
          </tr>
          <!--<tr>-->
    ...
    <div class="row row_margin">
      ...
      <div class="col-xs-7 col-sm-7 col-md-7 col-lg-6">
        <button @click="modifyData" type="button" class="btn btn-info select_button submit_button">提交</button>
      </div>
    </div>
  </div>
</template>
