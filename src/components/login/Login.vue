    ...
    <div class="login">
      ...
      <div class="login-center clearfix">
        ...
        <div class="login-center-input">
          <input type="text" name="" value="" v-model="telephone" placeholder="请输入您的用户名" onfocus="this.placeholder=''" onblur="this.placeholder='请输入您的用户名'"/>
      ...
      <div class="login-button">
        <router-link  to="/register" class="login-button">
          没有账号,现在注册 >>
        </router-link>
      </div>
    </div>
    ...
    export default {
      ...
      methods:{
        ...
        b:function(){
          ...
          axios.post(that.GLOBAL.HOST+'user/login/',{
